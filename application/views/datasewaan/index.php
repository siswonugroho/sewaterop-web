<section class="col-md mt-3 mx-1 mx-md-4">
  ...
  <main id="list-sewaan">
    ...
    <span class="d-flex py-3 mx-auto sticky-top bg-white">
      <a class="btn btn-primary mr-3 d-none d-md-flex align-items-center" href="<?= base_url('datasewaan/pagetambah') ?>">
...
<script src="<?= base_url('assets/js/sewaan.min.js') ?>"></script>
