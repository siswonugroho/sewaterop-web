<section class="col-md mt-3">
  ...
  <main class="mt-3 mx-2 mx-sm-5">
    <form action="<?= base_url('datasewaan/edit') ?>" method="post" novalidate>
      <div class="row">
        <div class="col-sm">
          <input type="text" hidden name="id_sewaan" id="id_sewaan" value="<?= $formvalue['id_pesanan'] ?>">
          <input type="text" hidden name="id_paket_lama" id="id_paket_lama" value="<?= $formvalue['id_paket'] ?>">
          <div class="form-group">
            <label for="nama_penyewa">Pilih penyewa</label>
            <div class="dropdown">
              <input type="text" hidden value="<?= $formvalue['id_pemesan'] ?>" name="id_penyewa" id="id_penyewa" autocomplete="off">
              <input type="text" required readonly value="<?= $formvalue['nama_pemesan'] ?>" class="form-control bg-white" name="nama_penyewa" id="nama_penyewa" autocomplete="off" data-toggle="dropdown">
          ...
          <div class="row">
            <div class="col-md col-lg-7 form-group">
              ...
              <input type="date" required class="form-control" value="<?= $formvalue['tgl_mulai'] ?>" name="tgl_mulai" id="tgl_mulai">
            </div>
            <div class="col-md col-lg-5 form-group">
              <label for="waktu_mulai" class="text-truncate">Waktu mulai</label>
              <input type="time" required class="form-control" value="<?= $formvalue['waktu_mulai'] ?>" name="waktu_mulai" id="waktu_mulai">
            </div>
          </div>
          <div class="row">
            <div class="col-md col-lg-7 form-group">
              <label for="tgl_selesai" class="text-truncate">Tanggal selesai</label>
              <input type="date" required class="form-control" value="<?= $formvalue['tgl_selesai'] ?>" name="tgl_selesai" id="tgl_selesai">
            </div>
            <div class="col-md col-lg-5 form-group">
              <label for="waktu_selesai" class="text-truncate">Waktu selesai</label>
              <input type="time" required class="form-control" value="<?= $formvalue['waktu_selesai'] ?>" name="waktu_selesai" id="waktu_selesai">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group list-barang d-block">
            ...
            <?php foreach ($formvalue['barang_sewaan']['id_barang'] as $key => $value) : ?>
              <div class="input-group list-item">
                <input type="number" readonly name="paket[jumlah_barang][]" class="form-control bg-white jumlah" value="<?= $formvalue['barang_sewaan']['jumlah_barang'][$key] ?>">
                <input type="hidden" name="paket[id_barang][]" class="jumlah" value="<?= $formvalue['barang_sewaan']['id_barang'][$key] ?>">
                <input type="text" readonly name="paket[nama_barang][]" class="form-control bg-white w-50 nama" value="<?= $formvalue['barang_sewaan']['nama_barang'][$key] ?>">
                <input type="hidden" name="paket[harga][]" class="harga" value="<?= $formvalue['barang_sewaan']['harga'][$key] ?>">
          ...
          <div class="form-group pilih-paket d-none">
            ...
            <div class="row row-cols-2 mx-0 daftar-paket-sewa" data-id-paket="<?= $formvalue['id_paket'] ?>" data-toggle="buttons">
        ...
        <div class="form-group pilih-paket d-block">
          <label>Pilih paket sewa</label>
          <div class="row row-cols-2 mx-0 daftar-paket-sewa btn-group-toggle" data-id-paket="<?= $formvalue['id_paket'] ?>" data-toggle="buttons">
