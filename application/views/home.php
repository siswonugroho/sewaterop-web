<section class="col-md m-0 m-md-3">
        ...
        <header class="p-2 my-2 my-md-1 bg-transparent">
            <figure class="d-flex d-md-none">
                <img src="<?= base_url('assets/img/sewaterop-logo.svg') ?>" alt="Logo sewaterop" style="height: 7vh;">
            </figure>
                ...
                <div class="col p-1">
                    <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(126deg, rgba(27,98,224,1) 0%, rgba(54,181,246,1) 100%);">
                        <div class="card-body text-white">
                            <h1 class="display-4 font-weight-bold"><?= $count_summary['jumlah-sewa'] ?></h1>
                            <span>Sewa berlangsung</span>
                        </div>
                        <div class="card-footer border-0 bg-transparent">
                            <a href="<?= base_url('datasewaan') ?>" class="font-weight-bold text-light">Lihat semua</a>
                        </div>
                    </div>
                </div>
                <div class="col p-1">
                    <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(126deg, rgba(23,178,210,1) 0%, rgba(16,217,174,1) 100%);">
                        <div class="card-body text-white">
                            <h1 class="display-4 font-weight-bold"><?= $count_summary['jumlah-barang'] ?></h1>
                            <span>Jenis barang</span>
                        </div>
                        <div class="card-footer border-0 bg-transparent">
                            <a href="<?= base_url('databarang') ?>" class="font-weight-bold text-light">Lihat semua</a>
                        </div>
                    </div>
                </div>
                <div class="col p-1">
                    <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(126deg, rgba(58,79,230,1) 0%, rgba(171,63,221,1) 100%);">
                        <div class="card-body text-white">
                            <h1 class="display-4 font-weight-bold"><?= $count_summary['jumlah-paket'] ?></h1>
                            <span>Paket sewa</span>
                        </div>
                        <div class="card-footer border-0 bg-transparent">
                            <a href="<?= base_url('datapaketsewa') ?>" class="font-weight-bold text-light">Lihat semua</a>
                        </div>
                    </div>
                </div>
                <div class="col p-1">
                    <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(126deg, rgba(230,58,131,1) 0%, rgba(243,143,67,1) 100%);">
                        <div class="card-body text-white">
                            <h1 class="display-4 font-weight-bold"><?= $count_summary['jumlah-blm-lunas'] ?></h1>
                            <span>Sewaan belum lunas</span>
                        </div>
                        <div class="card-footer border-0 bg-transparent">
                            <a href="<?= base_url('datariwayat/blmlunas') ?>" class="font-weight-bold text-light">Lihat semua</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mx-2">
                ...
                <div class="card-body">
                    <div class="row row-cols-3">
                        <a class="col text-dark d-flex flex-column justify-content-center align-items-center" href="<?= base_url('databarang') ?>">
                        ...
                        <a class="col text-dark d-flex flex-column justify-content-center align-items-center" href="<?= base_url('datapenyewa') ?>">
                        ...
                        <a class="col text-dark d-flex flex-column justify-content-center align-items-center" href="<?= base_url('datapaketsewa') ?>">
