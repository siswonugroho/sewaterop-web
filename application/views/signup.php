<div class="container d-flex flex-column align-items-center justify-content-around">
  ...
  <div class="row w-100 justify-content-center">
    <form action="<?= base_url('signup') ?>" class="col-md-4" method="post" novalidate>
  ...
  <p class="my-5">Sudah punya akun? <a href="<?= base_url('login') ?>" class="text-primary">Login.</a></p>
</div>
<script src="<?= base_url('assets/js/signup-validate.min.js') ?>"></script>