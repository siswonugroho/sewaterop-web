<section class="col-md mt-3">
    ...
    <main class="mt-3 mx-2 mx-sm-5">
        <div class="row">
            <div class="col-sm">
                <form action="<?= base_url('datapenyewa/edit') ?>" method="post" enctype="multipart/form-data" novalidate>
                    <input type="text" hidden readonly class="form-control" name="id_penyewa" id="id_penyewa" value="<?= $formvalue['id_pemesan'] ?>">
                    <div class="form-group">
                        <label for="nama_penyewa">Nama Penyewa</label>
                        <input type="text" required class="form-control" name="nama_penyewa" id="nama_penyewa" value="<?= $formvalue['nama_pemesan'] ?>">
                        <div class="invalid-feedback">Harap isi kolom ini</div>
                    </div>
                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" required class="form-control" name="username" id="username" value="<?= $formvalue['username'] ?>">
                        <div class="invalid-feedback">Harap isi kolom ini</div>
                    </div>
                    <div class="form-group">
                        <label for="stok">No. Telepon</label>
                        <input type="tel" required class="form-control" name="telepon" id="telepon" value="<?= $formvalue['telepon'] ?>">
                        <div class="invalid-feedback">Harap isi kolom ini</div>
                    </div>
                    <div class="form-group">
                        <label for="harga">Alamat</label>
                        <textarea rows="4" required class="form-control" name="alamat" id="alamat"><?= $formvalue['alamat'] ?></textarea>
                        <div class="invalid-feedback">Harap isi kolom ini</div>
                    </div>
