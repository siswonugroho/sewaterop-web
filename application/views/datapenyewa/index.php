<section class="col-md mt-3 mx-1 mx-md-4">
  ...
  <main id="list-penyewa">
    ...
    <span class="d-flex py-3 mx-auto sticky-top bg-white">
      <a class="btn btn-primary mr-3 d-none d-md-flex align-items-center" href="<?= base_url('datapenyewa/pagetambah') ?>">
      ...
      <span class="btn-group mb-2">
        <div class="btn-group">
          ...
          <div class="dropdown-menu dropdown-menu-right anim-fade shadow">
            ...
            <button class="dropdown-item sort" data-sort="username" type="button">Username</button>
          </div>
        </div>
...
<script src="<?= base_url('assets/js/penyewa.min.js') ?>"></script>