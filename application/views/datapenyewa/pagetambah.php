<section class="col-md mt-3">
    ...
    <main class="mt-3 mx-2 mx-sm-5">
        <div class="row">
            <div class="col-sm">
                <form action="<?= base_url('datapenyewa/tambah') ?>" method="post" enctype="multipart/form-data" novalidate>
                    <input type="text" hidden readonly class="form-control" name="id_penyewa" id="id_penyewa" value="<?= $id_penyewa ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" required class="form-control" name="telepon" id="telepon">
                        <div class="invalid-feedback">Harap isi kolom ini</div>
                    </div>
                    <div class="form-group">
