<section class="col-md mt-3 mx-1 mx-md-4">
  ...
  <main id="list-barang">
    ...
    <span class="d-flex py-3 mx-auto sticky-top bg-white">
      <a class="btn btn-primary mr-3 d-none d-md-flex align-items-center" href="<?= base_url('databarang/pagetambah') ?>">
    ...
    <div id="list-barang-container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 m-0 list">
...
<script src="<?= base_url('assets/js/barang.min.js') ?>"></script>
