<section class="col-md mt-3">
    ...
    <main class="mt-3 mx-2 mx-sm-5">
        <form action="<?= base_url('databarang/tambah') ?>" method="post" enctype="multipart/form-data" novalidate>
            <div class="row">
                <div class="col-sm">
                    <input type="text" hidden readonly class="form-control" name="id_barang" id="id_barang" value="<?= $id_barang ?>">
                ...
                <div class="col-sm">
                    <div class="form-group d-flex flex-column" style="width: 30vh;">
                        ...
                        <img src="" alt="foto barang" class="rounded-sm img-thumbnail" style="object-fit: cover; height: 30vh; width: 30vh;" onerror="this.onerror = null; this.src = '<?= base_url('assets/resources/img/noimg.png') ?>'" id="preview_foto_barang">
