            ...
            <div class="row">
                ...
                <div class="col-sm">
                    <div class="form-group d-flex flex-column" style="width: 30vh;">
                        ...
                        <img src="<?= BASEURL ?>/resources/img/databarang/<?= $data['formvalue']['foto_barang'] ?>" alt="foto barang" class="rounded-sm img-thumbnail" style="object-fit: cover; height: 30vh; width: 30vh;" onerror="this.onerror = null; this.src = '<?= BASEURL ?>/resources/img/noimg.png'" id="preview_foto_barang">
